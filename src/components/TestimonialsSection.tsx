...
const testimonials = [
  {
    ...
    rating: 5,
    borderColor: "#DED1C6",
    glowColor: "rgba(222, 209, 198, 0.15)",
  },
  {
    name: "Ð”Ð¾Ñ€Ð¶",
  ...
  },
  {
    ...
    rating: 5,
    borderColor: "#A77693",
    glowColor: "rgba(167, 118, 147, 0.15)",
  },
];
...
function TestimonialCard({ testimonial, index }: { testimonial: typeof testimonials[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="relative p-8 rounded-2xl bg-[#0F2D4D]"
      style={{
        border: `1px solid ${testimonial.borderColor}30`,
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-[#174871]/20">
          <div
          ...
          <div>
            ...
            <div className="text-[#DED1C6]/50 text-sm">{testimonial.role}</div>
          </div>
        </div>
      </div>
    </motion.div>
    ...
    <section className="py-24 relative" style={{ background: '#0F2D4D' }}>
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-[60px]">
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-4 border border-[#174871] text-[#DED1C6]/50 font-bold text-sm tracking-[2px] rounded-xl hover:border-[#A77693] hover:text-[#A77693] transition-all">
