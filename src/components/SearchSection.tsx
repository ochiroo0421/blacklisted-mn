  ...
  return (
    <section ref={ref} className="relative py-24" style={{ background: '#2B103D' }}>
      <div 
        ...
        style={{
          background: 'radial-gradient(circle, rgba(184, 246, 13, 0.5) 0%, transparent 70%)',
          filter: 'blur(80px)'
        }}
      />
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-6 md:px-[60px]">
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-4 p-2 rounded-2xl bg-[#2B103D] border border-[#6574FF]/50 neon-glow-primary">
              <svg className="w-6 h-6 text-[#B8F60D] ml-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <input
                ...
                className="flex-1 bg-transparent text-white placeholder-white/40 outline-none px-4 py-4 text-base"
              />
              <button className="px-8 py-4 bg-[#6574FF] text-white font-bold text-sm tracking-[2px] rounded-xl hover:bg-[#6574FF]/80 transition-all">
                Ð¥ÐÐ™Ð¥
              </button>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["Ð£Ð»Ð°Ð°Ð½Ð±Ð°Ð°Ñ‚Ð°Ñ€", "Ð”Ð°Ñ€Ñ…Ð°Ð½", "Ð­Ñ€Ð´ÑÐ½ÑÑ‚", "Ð‘Ð°ÑÐ½-Ó¨Ð»Ð³Ð¸Ð¹", "Ð¥Ó©Ð²ÑÐ³Ó©Ð»"].map((city) => (
              <button
                key={city}
                className="px-4 py-2 rounded-full border border-[#6574FF]/50 text-white/50 text-sm hover:border-[#B8F60D] hover:text-[#B8F60D] transition-all"
              >
                {city}
              </button>
            ))}
          ...
          <div className="text-white/40 text-sm">
            ...
            <span className="text-[#B8F60D] cursor-pointer hover:underline">Ð‘Ð°ÑÐ½Ð³Ð¾Ð» Ð´Ò¯Ò¯Ñ€ÑÐ³</span>
            {", "}
            <span className="text-[#B8F60D] cursor-pointer hover:underline">Ð‘Ð°Ñ‚</span>
            {", "}
            <span className="text-[#B8F60D] cursor-pointer hover:underline">Ð¡Ò¯Ñ…Ð±Ð°Ð°Ñ‚Ð°Ñ€ Ð´Ò¯Ò¯Ñ€ÑÐ³</span>
          </div>
        </motion.div>
      </div>
    </section>
