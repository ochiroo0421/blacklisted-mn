...
export default function ContactSection() {
  ...
  const inputClasses = "w-full px-4 py-3 bg-[#0F2D4D] border border-[#174871]/50 rounded-lg text-white placeholder-[#DED1C6]/40 outline-none focus:border-[#A77693] focus:shadow-[0_0_15px_rgba(167,118,147,0.3)] transition-all";

  return (
    <section ref={ref} className="py-24 relative" style={{ background: '#0F2D4D' }}>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-[1000px] mx-auto">
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#0F2D4D] border border-[#174871]/30">
                <div className="w-12 h-12 rounded-xl bg-[#174871]/30 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="text-[#DED1C6]/50">info@blacklisted.mn</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#0F2D4D] border border-[#174871]/30">
                ...
                <div>
                  ...
                  <div className="text-[#DED1C6]/50">+976 11 11 1111</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#0F2D4D] border border-[#174871]/30">
                ...
                <div>
                  ...
                  <div className="text-[#DED1C6]/50">Ð£Ð»Ð°Ð°Ð½Ð±Ð°Ð°Ñ‚Ð°Ñ€, ÐœÐ¾Ð½Ð³Ð¾Ð»</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form
              ...
              className="p-8 rounded-2xl bg-[#0F2D4D] border border-[#174871]/30 space-y-6"
              style={{ boxShadow: "0 0 40px rgba(23, 72, 113, 0.15)" }}
            >
              <div className="space-y-2">
                <label className="text-[#DED1C6] text-xs font-semibold tracking-[2px]">
                  ÐÐ­Ð 
                </label>
                <input
                  type="text"
