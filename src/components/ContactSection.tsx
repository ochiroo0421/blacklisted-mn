...
export default function ContactSection() {
  ...
  const inputClasses = "w-full px-4 py-3 bg-[#2B103D] border border-[#6574FF]/50 rounded-lg text-white placeholder-white/40 outline-none focus:border-[#B8F60D] focus:shadow-[0_0_15px_rgba(184,246,13,0.3)] transition-all";

  return (
    <section ref={ref} className="py-24 relative" style={{ background: '#2B103D' }}>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-[1000px] mx-auto">
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#2B103D] border border-[#6574FF]/20">
                <div className="w-12 h-12 rounded-xl bg-[#6574FF]/30 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="text-white/50">info@blacklisted.mn</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#2B103D] border border-[#6574FF]/20">
                ...
                <div>
                  ...
                  <div className="text-white/50">+976 11 11 1111</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 rounded-2xl bg-[#2B103D] border border-[#6574FF]/20">
                ...
                <div>
                  ...
                  <div className="text-white/50">Ð£Ð»Ð°Ð°Ð½Ð±Ð°Ð°Ñ‚Ð°Ñ€, ÐœÐ¾Ð½Ð³Ð¾Ð»</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form
              ...
              className="p-8 rounded-2xl bg-[#2B103D] border border-[#6574FF]/30 space-y-6"
              style={{ boxShadow: "0 0 40px rgba(101, 116, 255, 0.15)" }}
            >
              <div className="space-y-2">
                <label className="text-[#B8F60D] text-xs font-semibold tracking-[2px]">
                  ÐÐ­Ð 
                </label>
                <input
                  type="text"
