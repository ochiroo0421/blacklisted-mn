...
export default function Footer() {
  return (
    <footer className="bg-[#0A0C12] border-t border-[#023661]/30">
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] py-16">
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#76828E] text-sm max-w-[300px]">
              ÐœÐ¾Ð½Ð³Ð¾Ð»Ñ‹Ð½ Ñ‚Ò¯Ñ€ÑÑÑÐ¸Ð¹Ð½ Ð·Ð°Ñ… Ð·ÑÑÐ»Ð´ ÑˆÑƒÐ´Ð°Ñ€Ð³Ð° Ð±Ð°Ð¹Ð´Ð»Ñ‹Ð³ Ð±Ð¸Ð¹ Ð±Ð¾Ð»Ð³Ð¾Ñ…
            </p>
            <div className="flex gap-4 pt-2">
              <div className="w-10 h-10 rounded-full bg-[#023661]/30 flex items-center justify-center hover:bg-[#DB5227]/30 transition-colors cursor-pointer">
                <svg className="w-5 h-5 text-[#76828E]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <ul className="space-y-3">
                  {column.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-[#76828E] text-sm hover:text-[#DB5227] transition-colors"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-8 border-t border-[#023661]/20 text-center">
          <p className="text-[#76828E]/60 text-sm">
