...
export default function Footer() {
  return (
    <footer className="border-t border-[#6574FF]/30" style={{ background: '#2B103D' }}>
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] py-16">
        <div className="flex flex-col md:flex-row justify-between gap-12">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <div className="w-10 h-10 rounded-full bg-[#6574FF]/30 flex items-center justify-center hover:bg-[#B8F60D]/30 transition-colors cursor-pointer">
                ...
                <ul className="space-y-3">
                  {column.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-white/50 text-sm hover:text-[#B8F60D] transition-colors"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="mt-12 pt-8 border-t border-[#6574FF]/20 text-center">
